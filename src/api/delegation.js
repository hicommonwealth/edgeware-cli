...
exports.delegateTo = function (api, user, to) {
    return __awaiter(this, void 0, void 0, function () {
        var txNonce, tx, pubHash;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    tx = api.tx.delegation.delegate_to(to);
...
exports.undelegateFrom = function (api, user, from) {
    return __awaiter(this, void 0, void 0, function () {
        var txNonce, tx, pubHash;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    tx = api.tx.delegation.undelegate_from(from);
                    tx.sign(user, txNonce.toU8a());
                    return [4 /*yield*/, tx.send()];
                case 2:
                    pubHash = _a.sent();
...
exports.getDelegation = function (api, user) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, api.query.delegationStorage.delegateOf(user)];
